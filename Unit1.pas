  ...
  if us_operation = 7 then begin
    ...
    if radiobutton9.Checked then begin
      if radiobutton26.Checked then begin
        gates[1].start :=(Edit8.value);
        gates[1].width  :=(Edit9.value);
        gates[1].height  :=(Edit10.value);
      end else begin
        gates[1].start :=(Edit8.value*mm_us)*1000/us_sv+us_probe_delay;
        gates[1].width  :=(Edit9.value*mm_us)*1000/us_sv;
        gates[1].height  :=(Edit10.value);
      end;
    end;
    ...
    if radiobutton10.Checked then begin
      if radiobutton26.Checked then begin
      gates[2].start :=(Edit8.value);
      gates[2].width  :=(Edit9.value);
      gates[2].height  :=(Edit10.value);
      end else begin
      gates[2].start :=(Edit8.value*mm_us)*1000/us_sv+us_probe_delay;
      gates[2].width  :=(Edit9.value*mm_us)*1000/us_sv;
      gates[2].height  :=(Edit10.value);
      end;
    end;
    ...
    if radiobutton11.Checked then begin
      if radiobutton26.Checked then begin
      gates[3].start :=(Edit8.value);
      gates[3].width  :=(Edit9.value);
      gates[3].height  :=(Edit10.value);
      end else begin
      gates[3].start :=(Edit8.value*mm_us)*1000/us_sv+us_probe_delay;
      gates[3].width  :=(Edit9.value*mm_us)*1000/us_sv;
      gates[3].height  :=(Edit10.value);
      end;
    end;
...
if (us_operation = 6) then begin
           ...
           if (tmp * us_width) > 262088 then begin
              if  SpTBXComboBox2.ItemIndex < 3 then begin
                  SpTBXComboBox2.ItemIndex :=SpTBXComboBox2.ItemIndex + 1;
                  max_ff := SpTBXComboBox2.ItemIndex;
              end else begin
                  if radiobutton26.Checked  then  Edit7.SpinOptions.MaxValue :=  262088 / tmp;
                  if radiobutton25.Checked  then  Edit7.SpinOptions.MaxValue :=  262088 / tmp *(1000/us_sv);
              end;
           end;
        us_operation := 4;
  end;
 ...
 /////////////////////////////////////echo start
    ...
    //           US_Delay:= (us_echo_start_live-0.1);
      //         edit6.value:=(us_echo_start_live-0.1);
               ...
               edit6.value:=us_delay_old - (us_echo_start_live-tmp2);
 ...
 Screen.Cursor := crArrow;              j:=0;
    ...
    if j=0 then begin
      ...
      SpTBXButton102.Enabled := false;
        ...
        SpTBXButton99.Enabled := false;
        SpTBXButton100.Enabled := false;
        SpTBXButton101.Enabled := true;
        SpTBXButton102.Enabled := true;
    end;
